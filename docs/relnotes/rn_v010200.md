...
* mDNS functionality allowing you to set a network name for a device if nDNS is supported on your network
...
In addition, the about of time the menu is displayed is adjustable.  This settings on the _Settings/Application Settings_ page, under the _Advanced_ section.
...
An example of this is the display of the "about" page for the system. Normally this would required navigating the serial menu system. With the _quick_ command system, entering the value of "!about" at the serial console will display the about page.
